...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','base_ply.py',61),
  ('statement -> expression','statement',1,'p_statement_expr','base_ply.py',66),
  ('expression -> expression + expression','expression',3,'p_expression_binop','base_ply.py',71),
  ('expression -> expression - expression','expression',3,'p_expression_binop','base_ply.py',72),
  ('expression -> expression * expression','expression',3,'p_expression_binop','base_ply.py',73),
  ('expression -> expression / expression','expression',3,'p_expression_binop','base_ply.py',74),
  ('expression -> - expression','expression',2,'p_expression_uminus','base_ply.py',86),
  ('expression -> ( expression )','expression',3,'p_expression_group','base_ply.py',91),
  ('expression -> NUMBER','expression',1,'p_expression_number','base_ply.py',96),
  ('expression -> NAME','expression',1,'p_expression_name','base_ply.py',101),
]
